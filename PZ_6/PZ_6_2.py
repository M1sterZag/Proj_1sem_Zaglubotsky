# Вариант 11
# 2. Дано число R и список А размера N. Найти элемент списка, который наиболее близок
# к числу R (то есть такой элемент Аk, для которого величина |Ак - R| является
# минимальной).
